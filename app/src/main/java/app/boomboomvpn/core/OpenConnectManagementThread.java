...
import app.boomboomvpn.AuthFormHandler;
import app.boomboomvpn.R;
import app.boomboomvpn.VpnProfile;
...
public class OpenConnectManagementThread implements Runnable, OpenVPNManagement {
	...
	public OpenConnectManagementThread(){

	}
//	//added
//	public OpenConnectManagementThread(Context context, OpenVpnService openVpnService) {
//		mContext = context;
//		mOpenVPNService = openVpnService;
//		//mPrefs = mProfile.mPrefs;
//		mAppPrefs = PreferenceManager.getDefaultSharedPreferences(mContext);
...
//			}
	...
	private boolean runVPN() {
		...
		if (mOC.parseURL(mServerAddr) != 0) {
			...
			//MainActivity.mainActivity.onError();
//			MainActivity.mainActivity.onConnect(false);
			return false;
		}
...
//			MainActivity.mainActivity.onConnect(false);
		...
		//MainActivity.mainActivity.onConnect(true);
