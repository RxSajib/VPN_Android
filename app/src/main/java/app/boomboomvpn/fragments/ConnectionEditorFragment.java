...
package app.boomboomvpn.fragments;

import java.util.HashMap;
import java.util.Map;

import app.boomboomvpn.FileSelect;
import app.boomboomvpn.ConnectionEditorActivity;
import app.boomboomvpn.R;
import app.boomboomvpn.ShowTextPreference;
import app.boomboomvpn.TokenImportActivity;
